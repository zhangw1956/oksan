...
export default function(setting){
	...
	if (settings.dataType && settings.dataType.toLocaleLowerCase() == 'formdata') {
	...
	const instance = axios.create({
			baseURL: settings.serverURL || serverURL,
			timeout: settings.timeout || 20000,
			responseType: 'json',
			onUploadProgress: settings.onUploadProgress || function () {},
